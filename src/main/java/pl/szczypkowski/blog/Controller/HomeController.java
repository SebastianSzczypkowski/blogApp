...
public class HomeController {
    ...
    public HomeController(PostService postService, CommentRepo commentRepo, UserRepo userRepo, PostRepo postRepo) {
    ...
    public String addComment(@ModelAttribute("newComment")Comment comment,Principal principal ,Model model)
    {
        ...
        Optional<Post>postOptional = postRepo.findByUser(userOpitonal.get());
